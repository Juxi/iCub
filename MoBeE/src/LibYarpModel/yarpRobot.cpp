/*******************************************************************
 ***  Copyright (C) 2011-2015 Mikhail Frank, Leo Pape, and       ***
 ***                          Juxi Leitner                       ***
...
YarpRobot::YarpRobot( KinematicModel::Model* m,
                     ...
                     DT_ResponseClass robotBaseField ) : KinematicModel::Robot( m,
                                                                               robotTable,
                                                                               fieldTable,
                                                                               robotClass,
                                                                               baseClass,
                                                                               robotField,
                                                                               robotBaseField)
//YarpRobot::YarpRobot( KinematicModel::Model* m, DT_RespTableHandle t, DT_ResponseClass c, DT_ResponseClass b ) : KinematicModel::Robot(m,t,t,c,b)
{
...
void YarpRobot::addCollisionData( int idx, double x, double y, double z, const char* s )
{
	// this is a self collision
	yarp::os::Bottle& thisColl = collisionBottle.addList();
	thisColl.addInt(idx);
