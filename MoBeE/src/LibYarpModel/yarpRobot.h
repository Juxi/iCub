...
public:
	...
	void addCollisionData( int, double, double, double, const char* );
...
protected:
    ...
    /*** FRIENDS  ***/
    friend class YarpModel;
    friend class KinematicModel::BodyPart;
    friend class KinematicModel::Motor;
