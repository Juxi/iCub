...
public:
	Model( bool visualize = 1, bool verbse = false );	//!< Sets the default collision response for SOLID to DT_WITNESSED_RESPONSE
...
//	ObjectMover *objectMover;			//!< Object mover
    ...
    static DT_Bool repel( void* client_data, void* obj1, void* obj2, const DT_CollData *coll_data )
	{
        ...
        QVector3D F = QVector3D( coll_data->normal[0], coll_data->normal[1], coll_data->normal[2]);
